...
<br/><br/><br/>
 ...
 <div class="row">
  <form name="newtwo" method="POST" action="create_sur_back.jsp?catid=<%= request.getParameter("catid")%>">
  <div class="col-md-6 col-md-offset-3"><h5><strong>Survey Name</strong> <span style="color:red;">*</span></h5><input name="surname"  type="text" required="true" class="form-control" placeholder="Text input">
</div>
                            
<div class="row">
  <div class="col-md-6 col-md-offset-3"><h5> <br/><br/><strong>Description </strong><span style="color:red;">*</span></h5><textarea name="surdesc" required="true" class="form-control" rows="3"></textarea>
</div>
