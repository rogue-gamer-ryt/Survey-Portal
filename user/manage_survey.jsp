...
function confirmDelete(surid, surname) {
 ...
 <CENTER><h5> MANAGE SURVEY</h5></CENTER>
<br><br>
<div class="col-md-5">
                    ...
                    String err = "";
                try{
                err = session.getAttribute("delSurErr").toString();
                }
                catch(Exception e){
                }
                out.println(""+err);

                session.setAttribute("delSurErr","");
                    %></div>
                            <div class="col-md-10">
...
<%
                    ...
                    try{ 
                        ...
                        connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                        statement=connection.createStatement();
                        String sql1 ="SELECT * FROM list_of_surveys where showable=1 and category_id="+qp;
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                long suid = resultSet.getLong("survey_id");
                                String suname = resultSet.getString("survey_desc");%>
                                <tr>


                                    <td><%= ++count%></td>
                                    <td><a href="./manage_questions.jsp?ark=<%=suid %>"> 
                                            <%= suname %>
                                        </a>
                                    </td> 

                                    <td width="20%"> <a href="./edit_survey.jsp?surid=<%=suid %>"> <button class="btn1 btn-primary dropdown-toggle" type="button" >Edit  &nbsp;<span class="fui-new"></span></td></a>
                                    <td><button onclick="confirmDelete('<%=suid%>','<%=suname%>')" class="btn1 btn-primary-delete dropdown-toggle" type="button" >Delete <span class="fui-cross"></span></td>
