                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <br/><br/><br/>
                                <form id="newone" method="POST" action="create_cat_back.jsp">
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3"><h5><strong>Category Name:</strong> <span style="color:red;">*</span></h5><input name="catname" type="text" class="form-control" placeholder="Text input" required>
                                        </div>

                                        <div class="row">
                                            <div class="col-md-6 col-md-offset-3"><h5> <br/><br/><strong>Description </strong><span style="color:red;">*</span></h5><textarea name="catdesc" class="form-control" rows="3" required></textarea>
                                            </div>
										<!--<div class="col-sm-6"> -->
