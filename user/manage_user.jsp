...
<html lang="en" class="no-js">
    ...
    <body background="../images/bg2.jpg" style="padding-bottom:0px">
                ...
                try{ 
                    ...
                    resultSet = stmt.executeQuery(sq11);
                    resultSet.next();
                    String imgsrc=resultSet.getString("path");
                    connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                    statement=connection.createStatement();
                    String sqllll ="SELECT * FROM user_details where client_id = "+uid;
                    resultSet2 = statement.executeQuery(sqllll);
                    %>
                    <% if(!resultSet2.next()){  
                                out.println("loop testing");
                                 session.setAttribute("manUserError", "Please Fill the User Details");
