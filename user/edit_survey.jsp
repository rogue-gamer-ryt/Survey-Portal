<%-- 
    ...
    Created on : Feb 20, 2016, 3:06:45 PM
    Author     : jeyabalaji
--%>
...
<%
                ...
                try{ 
                    connection = DriverManager.getConnection(connectionUrl+dbName, userId, password);
                    statement=connection.createStatement();
                    String sql ="SELECT * FROM list_of_surveys where survey_id = "+sid;
                    resultSet = statement.executeQuery(sql);
                    resultSet.next();
                    %>
...
<br/><br/><br/>
 ...
 <div class="row">
  <form name="newtwo" method="POST" action="edit_sur_back.jsp">
  <div class="col-md-6 col-md-offset-3"><h5><strong>Survey Name</strong> </h5><input name="surname" type="text" class="form-control" placeholder="Text input" required value="<%= resultSet.getString("survey_desc") %>">
</div>
                            
<div class="row">
  <div class="col-md-6 col-md-offset-3"><h5> <br/><br/><strong>Description </strong></h5><textarea name="surdesc" class="form-control" required rows="3"><%= resultSet.getString("survey_intro") %></textarea>
</div>
...
<p align="center">
                         ...
                         <a href="manage_survey.jsp"><button type="button"  class="btn btn-primary-delete">Cancel</button></a>
