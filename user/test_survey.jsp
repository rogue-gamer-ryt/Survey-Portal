            ...
            <div class="container">
                ...
                <div class="component">
                        ...
                        <div class="row">
                            <div class="col-md-5 ">
                                <p align="right">
                                    ...
                                    <a href="create_survey.jsp"><button type="button" class="btn btn-primary">Add Survey</button></a>
                    ...
                    try{ 
                        ...
                        String sql ="SELECT * FROM list_of_surveys where category_id="+qp;
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= ++count%></td>
                                    <td><a href="./test_questions.jsp?ark=<%=resultSet.getInt("survey_id") %>"> 
