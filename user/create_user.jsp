                        ...
                        <form id="newone" method="POST" action="create_user_back.jsp">
                            <div class="row">
                                <div class="col-md-3 col-md-offset-3">
                                    <h5><strong>User Name </strong>  <span style="color:red;">*</span></h5><input name="uname" required type="text" class="form-control" placeholder="Text input" >
                                </div>
                                <div class="col-md-3 ">                                      
                                    <div class="form-group">
                                        <h5><strong>Password</strong><span style="color:red;">*</span> </h5>
                                        <input name="password" required id="password" class="form-control" type="password" placeholder="password" />
                                        <label>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-md-offset-3">
                                        <div class="form-group">
                                            ...
                                            <input name="email" required type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control" id="exampleInputEmail1" placeholder="Email">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input name="testmail" required type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,63}$" class="form-control" id="exampleInputEmail1" placeholder="Test Email">
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <% try {   //String xp=getAttribute("idx");
                                                statement = connection.createStatement();
                                                String sql = "Select * FROM list_of_surveys where category_id in (select cat_id from category where user_id =" + uid + ") AND showable=1";
                                                resultSet = statement.executeQuery(sql);
                                       ...
                                       <!-- </div> -->
                                        <div class="container2">
                                            ...
                                            <select id="destination_3" name="destination_3" data-text="Destination list" required>
